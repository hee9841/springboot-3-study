...
import com.springboot3.demo.config.jwt.JwtFactory;
import com.springboot3.demo.config.jwt.JwtProperties;
...
import com.springboot3.demo.user.service.RefreshTokenService;
...
class TokenApiControllerTest {
    ...
    public void crateNEwAccessToken() throws Exception {
        ...
        String requestBocy = objectMapper.writeValueAsString(request);
